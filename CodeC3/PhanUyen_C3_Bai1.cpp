...
int main()
{
	...
	cout <<"8. ap xep danh sach bang thuat toan Quick Sort"<<endl;
	cout <<"9.  Sap xep danh sach bang thuat toan Heap Sort"<<endl;
	cout <<"10.Tim kiem phan tu trong DS co thu tu"<<endl;
	cout <<"11.Tim kiem phan tu trong DS co thu tu"<<endl;
	cout <<"12. Thoat"<<endl;
	do
	{
		cout <<"\nMoi nhap so de chon thao tac: ";
		cin >>choice;
		switch(choice)
		{
		case 1:
